...
public class NaturalWatersClient implements ClientModConstructor {
    ...
    private static void registerEventHandlers() {
        ...
        FogEvents.RENDER.register(NaturalWatersClient::onRenderFog);
    }

    private static void onRenderFog(GameRenderer gameRenderer, Camera camera, float partialTick, FogRenderer.FogMode fogMode, FogType fogType, MutableFloat fogStart, MutableFloat fogEnd, MutableValue<FogShape> fogShape) {
